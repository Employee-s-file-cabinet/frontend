        ...
        <div className="column ">
            <div className="field  ">
              ...
              <div className="control control-horizontal-long">
                <input className="input career-development__input" type="text" placeholder='Управление персоналом' />
              </div>
            </div>
        </div>
        <div className="column is-one-third">
          <div className="field  field-cell">
            <legend className="label label label-horizontal is-one-third">Организация</legend>
            <div className="control career-development__control">
              <input className="input career-development__input" type="text" placeholder='IRS.Academy'/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="columns is-gapless career-development career-development-add career-development-remve">
        <div className="column is-one-third">
            <div className="field  field-cell">
              ...
              <div className="control career-development__control">
                <input className="input career-development__input" type="number" placeholder='26 000' />
              </div>
             </div>
        </div>
        <div className="column is-one-third">
          <div className="field  field-cell">
            <div className="control career-development__control">
              <legend className="label label label-horizontal is-one-third">Начало</legend>
        ...
        <div className="column is-one-third">
          <div className="field  field-cell">
            <legend className="label label label-horizontal is-one-third">Окончание</legend>
            <div className="control career-development__control">
              <input className="input career-development__input" type="date" />
            </div>
          </div>
