import './PersonalDataFormEdit.scss';

import 'bulma/css/bulma.min.css';

import {React}  from 'react';

export default function PersonalDataFormEdit() {


  return (
    <form action='#' method='post' className='personal-data-form-edit'>
      <div className="columns is-multiline is-mobile">
        ...
        <div className="column is-one-third">
              <div className="field  field-cell">
                  ...
                  <div className="control">
                    <input className="input" type="text" placeholder='Отделением УФМС России в г. Нижний Новогород' />
                  </div>
              </div>
        </div>
        <div className="column">
              ...
              <div className="file has-name  is-right is-fullwidth">
                <legend className="file-label label-type">
                  ...
                  <span className="file-cta">
                    ...
                    <span className="file-label label-type">
                      Выбрать файл
                    </span>
                  </span>
        ...
        <div className="column is-one-third">
          <div className="field  field-cell">
              ...
              <div className="control">
                <input className="input" type="text" placeholder='492-850-880-33' />
              </div>
          </div>
        </div>
        <div className="column">
        ...
        <div className="column">
          <div className="field  field-cell-big">
              ...
              <div className="control">
                <input className="input" type="text" placeholder='Россия, г. Нижний Новгород, Мичурина ул., д. 9 кв.6' />
              </div>
        ...
        <div className="column">
          <div className="field  field-cell-big">
              <legend className="label label-type">Согласие на обработку персональных данных</legend>
              <div className="file has-name  is-right is-fullwidth">
                <legend className="file-label label-type">
                  <input className="file-input" type="file" name="resume" />
                  <span className="file-cta">
        ...
        <div className='buttons-group'>
            <button className="button is-primary button-save">Сохранить</button>
            <button className="button is-primary is-outlined button-reset">Сбросить изменения</button>
        </div>
